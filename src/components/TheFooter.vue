...
<template>
    <div class="flex flex-col gap-5 justify-center items-center w-full pt-10 pb-2 bg-gray-900 shadow-2xl">
    ...
    <div class="w-full py-2">
        <h1 class="text-gray-400 text-sm font-light mb-0 text-center">All Rights Reserved By <a class="decoration-transparent text-yellow-500 hover:text-yellow-500 hover:decoration-yellow-500" href="https://qoqo.ga">QoQo.live</a></h1>
    </div>
</template>